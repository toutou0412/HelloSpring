...
/**
 * @author pengdayi
 * @ClassName: BanWordUtil
 * @Description:
 * @date 2023/5/9 下午8:42
 */
public class BanWordUtil {
     ...
     * @return
     */
    public static Map initKeyWord(String[] sensitiveWords) {
        try {
    ...
    public static void main(String[] args) {
        String[] sensitiveWords = new String[]{"日本人","日本鬼子","毛泽东"};
        initKeyWord(sensitiveWords);
        String txt = "长月烬明我是哈哈哈毛泽东，日本人";
//        checkSensitiveWord(txt,0,1);
        Set<String> sensitiveWord = getSensitiveWord(txt, 2);
        System.out.println("敏感词数量：" + sensitiveWord.size());
